...
$sql="INSERT INTO commenth(date,name,comment,post_id_fk)VALUES('$date','$name','$post_com','$post_id')";
if(mysqli_query($con,$sql)){
		echo "<script>window.open('pagesh.php?id=$post_id','_self')</script>";
		exit();
}
}
...
$delete_query = "delete from commenth where id='$delete_id' ";
...
$page_id = $_GET['id'];
	...
	$select_query = "select * from htutorial where id='$page_id'";
...
<?php
include("dbconnect.php");
$query = "select * from commenth where post_id_fk='$post_id'"; 
...
<div class="content-form">
<form style="float:right;" method="POST" action="updateh.php">
<input type="hidden" name="del" value="<?php echo $post_id2; ?>"/>
<input type="hidden" name="dele" value="<?php echo $post_id; ?>"/>
