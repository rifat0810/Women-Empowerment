...
$select_posts = "select * from member order by 1 DESC LIMIT 0,25";
$run_posts = mysqli_query($con,$select_posts);
while($row=mysqli_fetch_array($run_posts)){
	$post_id = $row['id']; 
	$post_uname = $row['username'];
	$post_email = $row['email'];
	$post_fname = $row['fullname'];
...
?>
		<div class="grid box">
			...
			<div class="grid-img-content">
				<a href="pagebo.php?id=<?php echo $post_id; ?>"><img src="admin/images/<?php echo $post_image; ?>" class="blog"  width="330" height="225" alt="" /></a>
				<p>SkupeId: <?php echo $post_uname; ?></p><br>
				<p>Email: <?php echo $post_email; ?></p><br>
				<p>Fullname: <?php echo $post_fname; ?></p><br>
				<div class="clearfix"> </div>
			</div>
		</div>
			<?php } ?>
