...
$select_posts = "select * from ctutorial order by 1 DESC LIMIT 0,3";
...
<video src="admin/images/<?php echo $post_image; ?>" width="90%" height="20%" alt="" />
<a href="pages.php?id=<?php echo $post_id; ?>" class="title"><?php echo $post_title; ?></a>
...
<?php } ?>
						...
						<div class="latest-articles">
							...
							<?php 
include("dbconnect.php");
$select_posts = "select * from htutorial order by 1 DESC LIMIT 0,3";
$run_posts = mysqli_query($con,$select_posts);
while($row=mysqli_fetch_array($run_posts)){
	$post_id = $row['id']; 
	$post_title = $row['title'];
...
<div class="world-news-grid">
<div>
<a href="pagesh.php?id=<?php echo $post_id; ?>">
<video src="admin/images/<?php echo $post_image; ?>" width="90%" height="20%" alt="" />
<a href="pagesh.php?id=<?php echo $post_id; ?>" class="title"><?php echo $post_title; ?></a>
<p><?php echo $post_content; ?></p>
</div>
<div>
<a href="pagesh.php?id=<?php echo $post_id; ?>">Read More</a>
</div>
</div>
<?php } ?>
