 ...
 include("dbconnect.php");
	...
	$post_title1 = $_POST['title'];
	 ...
	 move_uploaded_file($image_tmp,$local_image.$post_image1);
	  $update_query = "update post set title='$post_title1',date='$post_date1',images='$post_image1',content='$post_content1' where id='$update_id'";
			...
			<div class="panel-heading">
				<div class="panel-title">Edit Computer Tutorial Form</div>
			  		...
			  		<div class="panel-body">
						<form method="POST" action="editpost.php?edit_form=<?php echo $id; ?>" enctype="multipart/form-data">
