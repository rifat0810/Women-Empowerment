 ...
 include("dbconnect.php");
	...
	$post_title1 = $_POST['title'];
	 ...
	 move_uploaded_file($image_tmp,$local_image.$post_image1);
	  $update_query = "update blog set title='$post_title1',date='$post_date1',images='$post_image1',content='$post_content1' where id='$update_id'";
	...
	<div class="row">
		<div class="content-box-large">
			<div class="panel-heading">
				<div class="panel-title">Edit Blog Form</div>
			</div>
			  		<div class="panel-body">
						<form method="POST" action="editblogpost.php?edit_form=<?php echo $id; ?>" enctype="multipart/form-data">
							<div class="form-group"><br>
								<label for="inputEmail3" class="col-sm-2 control-label">Post Author:</label>
								<div class="col-sm-10">
								<input type="text" class="form-control" id="inputEmail3" name="author" placeholder="Author Name"  value="<?php echo $_SESSION['userr_name']; ?>" disabled>
								</div>
							</div>
							<br>
							<div class="form-group"><br>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
								<input type="file"  class="btn btn-default" id="exampleInputFile1" name="image" required> <img src="images/<?php echo $image;?>" width="20%" height="15%">
								<br><br>
								</div>
							</div>
