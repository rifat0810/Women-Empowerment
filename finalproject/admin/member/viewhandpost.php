...
$query = "select * from htutorial where author='$name'";
...
?>	
					...
					<tr class="odd gradeX">
						...
						<source src="images/<?php echo $image; ?>" type="video/ogg"> 
								...
								<td><a href="../deletehandpost.php?del=<?php echo $id; ?>">Delete</a></td>
		                        <td><a href="edithandpost.php?edit=<?php echo $id; ?>">Edit</a></td>
							</tr>
						</tbody>
						 <?php } ?>
					</table>
